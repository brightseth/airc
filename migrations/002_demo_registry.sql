-- AIRC Demo Registry — Schema
-- Run against the DEMO Neon Postgres (AIRC_DEMO_DATABASE_URL)
-- This is identical to 001_initial.sql — the demo registry uses the same schema
-- but a SEPARATE database to demonstrate federation between independent registries.
