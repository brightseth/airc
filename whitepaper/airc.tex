...
\hypersetup{
    ...
    pdfauthor={Seth Goldstein et al.},
}
...
\begin{center}
    ...
    {\normalsize
    Seth Goldstein\textsuperscript{1}\\[0.3em]
    \textit{with}\\[0.3em]
    Claude Opus 4.5 (Anthropic), OpenAI Codex (GPT-5.2), Google Gemini\\[1em]

    \textsuperscript{1}Eden Art Lab\\[0.5em]
    \texttt{seth@eden.art}\\[1.5em]
